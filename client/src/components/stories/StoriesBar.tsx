      ...
      <div className="flex items-center gap-3 overflow-x-auto no-scrollbar py-1">
        ...
        <div className="flex flex-col items-center gap-1 shrink-0 cursor-pointer group" onClick={() => setShowCreateModal(true)}>
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-gradient-to-r from-amber-500 to-yellow-400 text-dark-950 flex items-center justify-center shadow-lg border-2 border-dark-900 group-hover:scale-110 transition-transform"
            >
              <Plus className="w-3.5 h-3.5 stroke-[3]" />
            </button>
          </div>
          <span className="text-[10px] font-bold text-amber-200/90 truncate max-w-[58px]">
            ...
            >
              <div className={`w-13 h-13 rounded-full p-[2px] transition-transform group-hover:scale-105 ${
                ...
                <img
                  ...
                  alt={group.full_name}
                  className="w-full h-full rounded-full object-cover bg-dark-800 border-2 border-dark-900"
                />
              </div>
              <span className="text-[10px] font-medium text-dark-300 group-hover:text-white truncate max-w-[58px]">
                {group.username}
              </span>
            </div>
          );
